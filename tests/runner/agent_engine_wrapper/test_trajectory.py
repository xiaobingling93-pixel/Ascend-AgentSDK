...
class TestTrajectopy:
    ...
    @pytest.mark.parametrize("invalid_metrics, expected_exception, expected_msg", [
        ...
        (_metrics_env_time_type_invalid, TypeError, "metric env_time must be a number or None, got str"),
        (_metrics_env_time_negative_invalid, ValueError, "metric env_time must be non-negative if not None"),
        (_metrics_llm_time_negative_invalid, ValueError, "metric llm_time must be non-negative if not None"),

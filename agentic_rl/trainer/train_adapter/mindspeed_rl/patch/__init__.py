...
def apply_patch():
    ...
    from mindspeed_rl.datasets import prompt_dataset
    ...
    from .dataset_mapping import safe_build_index_mappings
    ...
    prompt_dataset._build_index_mappings = safe_build_index_mappings
